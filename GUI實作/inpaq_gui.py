...
sales_icon = sales_icon.subsample(10, 10)
sales_button = tk.Button(win, text='業務專區', image=sales_icon, compound= tk.LEFT, command=Sales, bg='white') # compound用來讓文字和圖片對齊
sales_button.grid(row=1, column=0, sticky=tk.W+tk.E+tk.N+tk.S, padx=40, pady=5)
# sales_button.config(width=6, height=2, font='微軟正黑體 20')

cs_button = tk.Button(win, text='CS專區', bg='white')
cs_button.grid(row=1, column=1, sticky=tk.W+tk.E+tk.N+tk.S, padx=40, pady=5)
# cs_button.config(width=6, height=4, font='微軟正黑體 20')

sample_center_button = tk.Button(win, text='樣品中心專區', bg='white')
...
sales_description = tk.Label(win, text='業務需要的功能都在這裡', bg='white', padx=10, pady=5, width=18)
sales_description.grid(row=2, column=0)
# sales_description.config(font='微軟正黑體')

cs_description = tk.Label(win, text='CS需要的功能都在這裡', bg='white', padx=10, pady=5, width=18)
cs_description.grid(row=2, column=1)
# cs_description.config(font='微軟正黑體')

sample_center_description = tk.Label(win, text='樣品中心需要的功能都在這裡', bg='white', padx=10, pady=5, width=20)
